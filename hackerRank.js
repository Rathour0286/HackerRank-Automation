...
let email = "abc@gmail.com"; // write here gmail and password
  ...
  let waitClickPromise = new Promise(function (resolve, reject) {
    ...
    waitForSelectorPromise
      .then(function () {
        ...
        let clickPromise = curTab.click(algoBtn,{ delay: 100 });
        return clickPromise;
      })
      .then(function () {
...
// cd H tab enter   to go on this folder on new terminal
// node.hackerRank.js
// npm i puppeteer to install puppeteer